...
im_path_mel_near_train = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/TRAIN/np MLS/"
...
im_path_L_MFCCs_near_train2 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/TRAIN/np SSLM from MFCCs cosine 2pool3/"
im_path_L_MFCCs_near_train3 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/TRAIN/np SSLM from Chromas euclidean 2pool3/"
im_path_L_MFCCs_near_train4 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/TRAIN/np SSLM from Chromas cosine 2pool3/"

im_path_mel_near_val = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/VALIDATION/np MLS/"
...
im_path_L_MFCCs_near_val2 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/VALIDATION/np SSLM from MFCCs cosine 2pool3/"
im_path_L_MFCCs_near_val3 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/VALIDATION/np SSLM from Chromas euclidean 2pool3/"
im_path_L_MFCCs_near_val4 = "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Inputs/VALIDATION/np SSLM from Chromas cosine 2pool3/"
...
dataset_sslms_train3 = SSMDataset(im_path_L_MFCCs_near_train3, labels_path, transforms=[padding_SSLM, normalize_image, borders])
dataset_sslms_train4 = SSMDataset(im_path_L_MFCCs_near_train4, labels_path, transforms=[padding_SSLM, normalize_image, borders])
...
dataset_sslms_val3 = SSMDataset(im_path_L_MFCCs_near_val3, labels_path, transforms=[padding_SSLM, normalize_image, borders])
dataset_sslms_val4 = SSMDataset(im_path_L_MFCCs_near_val4, labels_path, transforms=[padding_SSLM, normalize_image, borders])
...
trainloader_sslms3 = DataLoader(dataset_sslms_train3,
                               batch_size = batch_size,
                               num_workers=0,
                               shuffle=False)

trainloader_sslms4 = DataLoader(dataset_sslms_train4,
                               batch_size = batch_size,
                               num_workers=0,
                               shuffle=False)
...
valloader_sslms3 = DataLoader(dataset_sslms_val3,
                             batch_size = batch_size,
                             num_workers=0)

valloader_sslms4 = DataLoader(dataset_sslms_val4,
                             batch_size = batch_size,
                             num_workers=0)
...
for epoch in range(num_epochs):
    ...
    "==============================TRAIN LOOP================================="
    optimizer.zero_grad()
    for batch_idx, ((images_mels, labels_mels, labels_sec_mels),
                    (images_sslms, labels_sslms, labels_sec_sslms),
                    (images_sslms2, labels_sslms, labels_sec_sslms),
                    (images_sslms3, labels_sslms, labels_sec_sslms),
                    (images_sslms4, labels_sslms, labels_sec_sslms)) in enumerate(zip(trainloader_mels,trainloader_sslms,trainloader_sslms2,trainloader_sslms3,trainloader_sslms4)):
        ...
        plt.show()
        """
        images_sslms = torch.cat((images_sslms,images_sslms2,images_sslms3,images_sslms4), axis = 1)
    ...
    with torch.no_grad(): #para que no calcule gradientes en validación
        for batch_idx, ((images_mels, labels_mels, labels_sec_mels),
                        ...
                        (images_sslms2, labels_sslms, labels_sec_sslms),
                        (images_sslms3, labels_sslms, labels_sec_sslms),
                        (images_sslms4, labels_sslms, labels_sec_sslms)) in enumerate(zip(valloader_mels,valloader_sslms,valloader_sslms2,valloader_sslms3,valloader_sslms4)):
