...
model.load_state_dict(torch.load("/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Trained models/MLS_SSLM_MFCCs_euclidean_2pool3/saved_model_" + epochs + "epochs.bin", map_location=torch.device('cpu')))
model.eval()
